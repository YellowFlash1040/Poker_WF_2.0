...
namespace Poker_WF
{
    public partial class GameForm : Form
    {
        ...
        public GameForm()
        {
            ...
            int[] playersBanks = new int[4];
            for (int i = 0; i < playersBanks.Length; i++)
            {
                playersBanks[i] = (int)((random.Next(9) / 10.0 + random.Next(1, 3)) * 1000);
            }

            GraphicPokerPlayer FirstPlayer = new GraphicPokerPlayer("Alexander", new GraphicCardSet(FirstPlayer_panel), 1000,
            ...
            GraphicPokerPlayer SecondPlayer = new GraphicPokerPlayer("Mihail", new GraphicCardSet(SecondPlayer_panel), 1200,
            ...
            GraphicPokerPlayer ThirdPlayer = new GraphicPokerPlayer("Oleg", new GraphicCardSet(ThirdPlayer_panel), 1300,
            ...
            GraphicPokerPlayer FourthPlayer = new GraphicPokerPlayer("Nikolai", new GraphicCardSet(FourthPlayer_panel), 2000,
