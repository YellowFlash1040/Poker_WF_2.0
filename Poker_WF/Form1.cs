...
namespace Poker_WF
{
    public partial class GameForm : Form
    {
        ...
        public GameForm()
        {
            ...
            GraphicPokerPlayer FirstPlayer = new GraphicPokerPlayer("FirstPlayer", new GraphicCardSet(FirstPlayer_panel), 500,
            ...
            GraphicPokerPlayer SecondPlayer = new GraphicPokerPlayer("SecondPlayer", new GraphicCardSet(SecondPlayer_panel), 2000,
            ...
            GraphicPokerPlayer FourthPlayer = new GraphicPokerPlayer("FourthPlayer", new GraphicCardSet(FourthPlayer_panel), 900,
